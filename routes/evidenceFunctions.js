  ...
  await Promise.all(
    records.map(async (record) => {
      if (record.id) {
        ...
        const fields = Object.keys(record).filter((key) => key !== "trends");
